...
public class GeodePlusGeodeBiomeModifier {
    ...
    public void init() {
        ...
        modifications.add(ModificationPhase.ADDITIONS, biomeSelectionContext -> true, (biomeSelectionContext, builder) -> {
            ...
            if (biome.is(GeodePlusTagRegistry.Biomes.HAS_PRISMARINE_GEODE) && !biome.is(GeodePlusTagRegistry.Biomes.BLACKLIST_BIOMES) && GeodePlusCommonConfigs.SHOULD_GENERATE_DEEP_OCEAN_PRISMARINE_GEODE.get()) {
            ...
            //Stone
            if (biome.is(GeodePlusTagRegistry.Biomes.HAS_DIAMOND_GEODE) && !biome.is(GeodePlusTagRegistry.Biomes.BLACKLIST_BIOMES) && GeodePlusCommonConfigs.SHOULD_GENERATE_STONE_DIAMOND_GEODE.get()) {
            ...
            if (biome.is(GeodePlusTagRegistry.Biomes.HAS_EMERALD_GEODE) && !biome.is(GeodePlusTagRegistry.Biomes.BLACKLIST_BIOMES) && GeodePlusCommonConfigs.SHOULD_GENERATE_STONE_EMERALD_GEODE.get()) {
            ...
            if (biome.is(GeodePlusTagRegistry.Biomes.HAS_REDSTONE_GEODE) && !biome.is(GeodePlusTagRegistry.Biomes.BLACKLIST_BIOMES) && GeodePlusCommonConfigs.SHOULD_GENERATE_STONE_REDSTONE_GEODE.get()) {
            ...
            //Deepslate
            if (biome.is(GeodePlusTagRegistry.Biomes.HAS_DIAMOND_GEODE) && !biome.is(GeodePlusTagRegistry.Biomes.BLACKLIST_BIOMES) && GeodePlusCommonConfigs.SHOULD_GENERATE_DEEPSLATE_DIAMOND_GEODE.get()) {
            ...
            if (biome.is(GeodePlusTagRegistry.Biomes.HAS_EMERALD_GEODE) && !biome.is(GeodePlusTagRegistry.Biomes.BLACKLIST_BIOMES) && GeodePlusCommonConfigs.SHOULD_GENERATE_DEEPSLATE_EMERALD_GEODE.get()) {
            ...
            if (biome.is(GeodePlusTagRegistry.Biomes.HAS_LAPIS_GEODE) && !biome.is(GeodePlusTagRegistry.Biomes.BLACKLIST_BIOMES) && GeodePlusCommonConfigs.SHOULD_GENERATE_DEEPSLATE_LAPIS_GEODE.get()) {
            ...
            if (biome.is(GeodePlusTagRegistry.Biomes.HAS_REDSTONE_GEODE) && !biome.is(GeodePlusTagRegistry.Biomes.BLACKLIST_BIOMES) && GeodePlusCommonConfigs.SHOULD_GENERATE_DEEPSLATE_REDSTONE_GEODE.get()) {
            ...
            //Sculk
            if (biome.is(GeodePlusTagRegistry.Biomes.HAS_ECHO_GEODE) && !biome.is(GeodePlusTagRegistry.Biomes.BLACKLIST_BIOMES) && GeodePlusCommonConfigs.SHOULD_GENERATE_SCULK_DIAMOND_GEODE.get()) {
            ...
            if (biome.is(GeodePlusTagRegistry.Biomes.HAS_ECHO_GEODE) && !biome.is(GeodePlusTagRegistry.Biomes.BLACKLIST_BIOMES) && GeodePlusCommonConfigs.SHOULD_GENERATE_SCULK_EMERALD_GEODE.get()) {
            ...
            if (biome.is(GeodePlusTagRegistry.Biomes.HAS_ECHO_GEODE) && !biome.is(GeodePlusTagRegistry.Biomes.BLACKLIST_BIOMES)&& GeodePlusCommonConfigs.SHOULD_GENERATE_ECHO_GEODE.get()) {
                builder.getGenerationSettings().addFeature(GenerationStep.Decoration.UNDERGROUND_DECORATION, getPlacedFeatureKey("echo_geode"));
            }
            //Netherrack
            if (biome.is(GeodePlusTagRegistry.Biomes.HAS_NETHER_ANCIENT_DEBRIS_GEODE) && !biome.is(GeodePlusTagRegistry.Biomes.BLACKLIST_BIOMES) && GeodePlusCommonConfigs.SHOULD_GENERATE_NETHER_ANCIENT_DEBRIS_GEODE.get()) {
            ...
            if (biome.is(GeodePlusTagRegistry.Biomes.HAS_NETHER_GOLD_NUGGET_GEODE) && !biome.is(GeodePlusTagRegistry.Biomes.BLACKLIST_BIOMES) && GeodePlusCommonConfigs.SHOULD_GENERATE_NETHER_GOLD_NUGGET_DEBRIS_GEODE.get()) {
            ...
            if (biome.is(GeodePlusTagRegistry.Biomes.HAS_NETHER_QUARTZ_GEODE) && !biome.is(GeodePlusTagRegistry.Biomes.BLACKLIST_BIOMES) && GeodePlusCommonConfigs.SHOULD_GENERATE_NETHER_QUARTZ_GEODE.get()) {
            ...
            //Basalt
            if (biome.is(GeodePlusTagRegistry.Biomes.HAS_BASALT_ANCIENT_DEBRIS_GEODE) && !biome.is(GeodePlusTagRegistry.Biomes.BLACKLIST_BIOMES) && GeodePlusCommonConfigs.SHOULD_GENERATE_BASALT_ANCIENT_DEBRIS_GEODE.get()) {
            ...
            if (biome.is(GeodePlusTagRegistry.Biomes.HAS_BASALT_GLOWSTONE_GEODE) && !biome.is(GeodePlusTagRegistry.Biomes.BLACKLIST_BIOMES) && GeodePlusCommonConfigs.SHOULD_GENERATE_BASALT_GLOWSTONE_GEODE.get()) {
            ...
            if (biome.is(GeodePlusTagRegistry.Biomes.HAS_BASALT_GOLD_NUGGET_GEODE) && !biome.is(GeodePlusTagRegistry.Biomes.BLACKLIST_BIOMES) && GeodePlusCommonConfigs.SHOULD_GENERATE_BASALT_GOLD_NUGGET_DEBRIS_GEODE.get()) {
            ...
            if (biome.is(GeodePlusTagRegistry.Biomes.HAS_BLACKSTONE_GLOWSTONE_GEODE) && !biome.is(GeodePlusTagRegistry.Biomes.BLACKLIST_BIOMES) && GeodePlusCommonConfigs.SHOULD_GENERATE_BLACKSTONE_GLOWSTONE_GEODE.get()) {
            ...
            if (biome.is(GeodePlusTagRegistry.Biomes.HAS_BLACKSTONE_GOLD_NUGGET_GEODE) && !biome.is(GeodePlusTagRegistry.Biomes.BLACKLIST_BIOMES) && GeodePlusCommonConfigs.SHOULD_GENERATE_BLACKSTONE_GOLD_NUGGET_DEBRIS_GEODE.get()) {
            ...
            if (biome.is(GeodePlusTagRegistry.Biomes.HAS_BLACKSTONE_QUARTZ_GEODE) && !biome.is(GeodePlusTagRegistry.Biomes.BLACKLIST_BIOMES) && GeodePlusCommonConfigs.SHOULD_GENERATE_BLACKSTONE_QUARTZ_GEODE.get()) {
            ...
            //End
            if (biome.is(GeodePlusTagRegistry.Biomes.HAS_WRAPPIST_GEODE) && !biome.is(GeodePlusTagRegistry.Biomes.BLACKLIST_BIOMES) && GeodePlusCommonConfigs.SHOULD_GENERATE_END_WRAPPIST_GEODE.get()) {
