...
public class GeodePlusBlocksRegistry {
    ...
    public static final Supplier<Block> BUDDING_CELESTITE = registerBlock("budding_celestite",
            () -> new BuddingCelestiteBlock(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_CYAN).randomTicks().strength(3F).sound(SoundType.AMETHYST).requiresCorrectToolForDrops()));
    ...
    public static final Supplier<CelestiteClusterBlock> CELESTITE_CLUSTER = registerBlock("celestite_cluster",
            () -> new CelestiteClusterBlock(7, 3, BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_CYAN).forceSolidOn().noOcclusion().randomTicks().sound(SoundType.AMETHYST).strength(3F).lightLevel( (p_60929_) -> 8)));
    ...
    public static final Supplier<OresClusterBlock> LAPIS_CLUSTER = registerBlock("lapis_cluster",
            () -> new OresClusterBlock(7, 3, BlockBehaviour.Properties.copy(Blocks.AMETHYST_CLUSTER).noOcclusion().randomTicks().sound(SoundType.AMETHYST).strength(3F).lightLevel( (p_60929_) -> 8)));
    public static final Supplier<LargeOresClusterBlock> LARGE_LAPIS_BUD = registerBlock("large_lapis_bud",
            () -> new LargeOresClusterBlock(5, 3, BlockBehaviour.Properties.copy(Blocks.LARGE_AMETHYST_BUD).sound(SoundType.AMETHYST).lightLevel((p_60929_) -> 2)));
    public static final Supplier<MediumOresClusterBlock> MEDIUM_LAPIS_BUD = registerBlock("medium_lapis_bud",
            () -> new MediumOresClusterBlock(4, 3, BlockBehaviour.Properties.copy(Blocks.MEDIUM_AMETHYST_BUD).sound(SoundType.AMETHYST).lightLevel((p_60929_) -> 1)));
    ...
    public static final Supplier<RedstoneOresClusterBlock> REDSTONE_CRYSTAL = registerBlock("redstone_crystal",
            () -> new RedstoneOresClusterBlock(7, 3, BlockBehaviour.Properties.copy(Blocks.AMETHYST_CLUSTER).noOcclusion().randomTicks().sound(SoundType.AMETHYST).strength(3F).lightLevel( (p_60929_) -> 8)));
    public static final Supplier<RedstoneOresClusterBlock> LARGE_REDSTONE_BUD = registerBlock("large_redstone_bud",
            () -> new RedstoneOresClusterBlock(5, 3, BlockBehaviour.Properties.copy(Blocks.LARGE_AMETHYST_BUD).sound(SoundType.AMETHYST).lightLevel((p_60929_) -> 2)));
    public static final Supplier<RedstoneOresClusterBlock> MEDIUM_REDSTONE_BUD = registerBlock("medium_redstone_bud",
            () -> new RedstoneOresClusterBlock(4, 3, BlockBehaviour.Properties.copy(Blocks.MEDIUM_AMETHYST_BUD).sound(SoundType.AMETHYST).lightLevel((p_60929_) -> 1)));
    ...
    public static final Supplier<Block> QUARTZ_CRYSTAL = registerBlock("nether_quartz_crystal",
            () -> new QuartzCrystalBlock(7, 3, BlockBehaviour.Properties.copy(Blocks.AMETHYST_CLUSTER).noOcclusion().randomTicks().sound(SoundType.NETHER_ORE).strength(3F).lightLevel( (p_60929_) -> 8)));
    public static final Supplier<Block> LARGE_QUARTZ_BUD = registerBlock("large_nether_quartz_bud",
            () -> new QuartzCrystalBlock(5, 3, BlockBehaviour.Properties.copy(Blocks.LARGE_AMETHYST_BUD).sound(SoundType.NETHER_ORE).lightLevel((p_60929_) -> 2)));
    public static final Supplier<Block> MEDIUM_QUARTZ_BUD = registerBlock("medium_nether_quartz_bud",
            () -> new QuartzCrystalBlock(4, 3, BlockBehaviour.Properties.copy(Blocks.MEDIUM_AMETHYST_BUD).sound(SoundType.NETHER_ORE).lightLevel((p_60929_) -> 1)));
    ...
    public static final Supplier<Block> GOLD_NUGGET_CLUSTER = registerBlock("nether_gold_nugget_cluster",
            () -> new NetherGoldClusterBlock(7, 3, BlockBehaviour.Properties.copy(Blocks.AMETHYST_CLUSTER).noOcclusion().randomTicks().sound(SoundType.NETHER_GOLD_ORE).strength(3F).lightLevel( (p_60929_) -> 8)));
    public static final Supplier<Block> LARGE_GOLD_NUGGET_BUD = registerBlock("large_nether_gold_nugget_bud",
            () -> new NetherGoldClusterBlock(5, 3, BlockBehaviour.Properties.copy(Blocks.LARGE_AMETHYST_BUD).sound(SoundType.NETHER_GOLD_ORE).lightLevel((p_60929_) -> 2)));
    public static final Supplier<Block> MEDIUM_GOLD_NUGGET_BUD = registerBlock("medium_nether_gold_nugget_bud",
            () -> new NetherGoldClusterBlock(4, 3, BlockBehaviour.Properties.copy(Blocks.MEDIUM_AMETHYST_BUD).sound(SoundType.NETHER_GOLD_ORE).lightLevel((p_60929_) -> 1)));
    ...
    public static final Supplier<Block> GLOWSTONE_CLUSTER = registerBlock("nether_glowstone_cluster",
            () -> new GlowstoneClusterBlock(7, 3, BlockBehaviour.Properties.copy(Blocks.AMETHYST_CLUSTER).noOcclusion().randomTicks().sound(SoundType.GLASS).strength(3F).lightLevel( (p_60929_) -> 15)));
    public static final Supplier<Block> LARGE_GLOWSTONE_BUD = registerBlock("large_nether_glowstone_bud",
            () -> new GlowstoneClusterBlock(5, 3, BlockBehaviour.Properties.copy(Blocks.LARGE_AMETHYST_BUD).sound(SoundType.GLASS).lightLevel((p_60929_) -> 5)));
    public static final Supplier<Block> MEDIUM_GLOWSTONE_BUD = registerBlock("medium_nether_glowstone_bud",
            () -> new GlowstoneClusterBlock(4, 3, BlockBehaviour.Properties.copy(Blocks.MEDIUM_AMETHYST_BUD).sound(SoundType.GLASS).lightLevel((p_60929_) -> 3)));
    public static final Supplier<Block> SMALL_GLOWSTONE_BUD = registerBlock("small_nether_glowstone_bud",
            () -> new GlowstoneClusterBlock(3, 4, BlockBehaviour.Properties.copy(Blocks.SMALL_AMETHYST_BUD).sound(SoundType.GLASS).lightLevel((p_60929_) -> 2)));
    ...
    public static final Supplier<Block> ANCIENT_DEBRIS_CLUSTER = registerBlock("nether_ancient_debris_cluster",
            () -> new WrappistClusterBlock(7, 3, BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_BLACK).noOcclusion().randomTicks().sound(SoundType.ANCIENT_DEBRIS).strength(10F).lightLevel((p_60929_) -> 8)));
    ...
    public static final Supplier<Block> WRAPPIST_CLUSTER = registerBlock("wrappist_cluster",
            () -> new WrappistClusterBlock(7, 3, BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_LIGHT_BLUE).noOcclusion().randomTicks().sound(SoundType.AMETHYST_CLUSTER).strength(3F).lightLevel((p_60929_) -> 8)));
    ...
    public static final Supplier<WrappistPedestalBlock> WRAPPIST_PEDESTAL = registerBlock("wrappist_pedestal",
            () -> new WrappistPedestalBlock(BlockBehaviour.Properties.copy(WRAPPIST_BLOCK.get()).randomTicks().noOcclusion().lightLevel((p_60929_) -> 8)));

    public static final Supplier<GlassBlock> WRAPPIST_GLASS = registerBlock("wrappist_glass", ()-> new GlassBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).mapColor(MapColor.COLOR_LIGHT_BLUE)));
    public static final Supplier<GlassBlock> CELESTITE_GLASS = registerBlock("celestite_glass", ()-> new GlassBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).mapColor(MapColor.COLOR_CYAN)));
    public static final Supplier<GlassBlock> PINK_TOPAZ_GLASS = registerBlock("pink_topaz_glass", ()-> new GlassBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).mapColor(MapColor.COLOR_PINK)));
    ...
    private static <T extends Block> void registerBlockItem(String name, Supplier<T> block) {
        RegistryHelper.registerItem(name, () -> new BlockItem(block.get(),
                new Item.Properties()));
    }
