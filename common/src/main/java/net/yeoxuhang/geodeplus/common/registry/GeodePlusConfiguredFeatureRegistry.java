...
import static net.yeoxuhang.geodeplus.common.registry.GeodePlusBlocksRegistry.*;
...
public class GeodePlusConfiguredFeatureRegistry {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
        register(context, CRYSTAL_SPIKE, GeodePlusFeatureRegistry.CRYSTAL_SPIKE.get(), new GeodeCrystalSpikeConfig((QUARTZ_CRYSTAL_BLOCK.get()).defaultBlockState(), (QUARTZ_CRYSTAL.get()).defaultBlockState(), UniformInt.of(1, 3), CaveSurface.CEILING));
        register(context, CRYSTAL_SPIKE_FLOOR, GeodePlusFeatureRegistry.CRYSTAL_SPIKE.get(), new GeodeCrystalSpikeConfig((QUARTZ_CRYSTAL_BLOCK.get()).defaultBlockState(), (QUARTZ_CRYSTAL.get()).defaultBlockState(), UniformInt.of(1, 3), CaveSurface.FLOOR));
        register(context, GLOWSTONE_CRYSTAL_SPIKE, GeodePlusFeatureRegistry.CRYSTAL_SPIKE.get(), new GeodeCrystalSpikeConfig(GLOWSTONE_CLUSTER_BLOCK.get().defaultBlockState(), (GLOWSTONE_CLUSTER.get()).defaultBlockState(), UniformInt.of(1, 3), CaveSurface.CEILING));
        register(context, GLOWSTONE_CRYSTAL_SPIKE_FLOOR, GeodePlusFeatureRegistry.CRYSTAL_SPIKE.get(), new GeodeCrystalSpikeConfig(GLOWSTONE_CLUSTER_BLOCK.get().defaultBlockState(), (GLOWSTONE_CLUSTER.get()).defaultBlockState(), UniformInt.of(1, 3), CaveSurface.FLOOR));
        register(context, ECHO_CRYSTAL_SPIKE, GeodePlusFeatureRegistry.ECHO_CRYSTAL_SPIKE.get(), new GeodeCrystalSpikeConfig((Blocks.SCULK).defaultBlockState(), (ECHO_CRYSTAL.get()).defaultBlockState(), UniformInt.of(1, 3), CaveSurface.CEILING));
        register(context, ECHO_CRYSTAL_SPIKE_FLOOR, GeodePlusFeatureRegistry.ECHO_CRYSTAL_SPIKE.get(), new GeodeCrystalSpikeConfig((Blocks.SCULK).defaultBlockState(), (ECHO_CRYSTAL.get()).defaultBlockState(), UniformInt.of(1, 3), CaveSurface.FLOOR));
        register(context, WRAPPIST_CRYSTAL_SPIKE, GeodePlusFeatureRegistry.WRAPPIST_CRYSTAL_SPIKE.get(), new GeodeCrystalSpikeConfig((WRAPPIST_BLOCK.get()).defaultBlockState(), (WRAPPIST_CLUSTER.get()).defaultBlockState(), UniformInt.of(1, 3), CaveSurface.FLOOR));
        register(context, PRISMARINE_CRYSTAL_SPIKE, GeodePlusFeatureRegistry.OCEAN_CRYSTAL_SPIKE.get(), new GeodeCrystalSpikeConfig(PRISMARINE_CLUSTER_BLOCK.get().defaultBlockState(), (PRISMARINE_CLUSTER.get()).defaultBlockState(), UniformInt.of(1, 3), CaveSurface.FLOOR));
        register(context, ANCIENT_DEBRIS_GEODE, GeodePlusFeatureRegistry.GEODE.get(), new GeodeConfiguration(
                new GeodeBlockSettings(simple(Blocks.AIR),
                        ...
                        GeodePlusTagRegistry.Blocks.GEODES_CANNOT_REPLACE, GeodePlusTagRegistry.Blocks.GEODE_INVALID_BLOCKS),
        ...
        register(context, BASALT_ANCIENT_DEBRIS_GEODE, GeodePlusFeatureRegistry.GEODE.get(), new GeodeConfiguration(
                new GeodeBlockSettings(simple(Blocks.AIR),
                        simple(Blocks.NETHERRACK),
                        ...
                        GeodePlusTagRegistry.Blocks.GEODES_CANNOT_REPLACE, GeodePlusTagRegistry.Blocks.GEODE_INVALID_BLOCKS),
                new GeodeLayerSettings(1.7D, 2.2D, 3.2D, 4.2D), new GeodeCrackSettings(0.95D, 2.0D, 2), 0.35D, 0.083D, true, UniformInt.of(4, 6), UniformInt.of(3, 4), UniformInt.of(1, 2), -16, 16, 0.05D, 1));
        register(context, BLACKSTONE_ANCIENT_DEBRIS_GEODE, GeodePlusFeatureRegistry.GEODE.get(), new GeodeConfiguration(
                new GeodeBlockSettings(simple(Blocks.AIR),
                        simple(Blocks.NETHERRACK),
                        ...
                        GeodePlusTagRegistry.Blocks.GEODES_CANNOT_REPLACE, GeodePlusTagRegistry.Blocks.GEODE_INVALID_BLOCKS),
                new GeodeLayerSettings(1.7D, 2.2D, 3.2D, 4.2D), new GeodeCrackSettings(0.95D, 2.0D, 2), 0.35D, 0.083D, true, UniformInt.of(4, 6), UniformInt.of(3, 4), UniformInt.of(1, 2), -16, 16, 0.05D, 1));
        register(context, GLOWSTONE_GEODE, GeodePlusFeatureRegistry.GEODE.get(), new GeodeConfiguration(
                new GeodeBlockSettings(simple(Blocks.AIR),
                        simple(Blocks.NETHERRACK),
                        ...
                        GeodePlusTagRegistry.Blocks.GEODES_CANNOT_REPLACE, GeodePlusTagRegistry.Blocks.GEODE_INVALID_BLOCKS),
                new GeodeLayerSettings(1.7D, 2.2D, 3.2D, 4.2D), new GeodeCrackSettings(0.95D, 2.0D, 2), 0.35D, 0.083D, true, UniformInt.of(4, 6), UniformInt.of(3, 4), UniformInt.of(1, 2), -16, 16, 0.05D, 1));
        register(context, BASALT_GLOWSTONE_GEODE, GeodePlusFeatureRegistry.GEODE.get(), new GeodeConfiguration(
                new GeodeBlockSettings(simple(Blocks.AIR),
                        simple(Blocks.NETHERRACK),
                        ...
                        GeodePlusTagRegistry.Blocks.GEODES_CANNOT_REPLACE, GeodePlusTagRegistry.Blocks.GEODE_INVALID_BLOCKS),
                new GeodeLayerSettings(1.7D, 2.2D, 3.2D, 4.2D), new GeodeCrackSettings(0.95D, 2.0D, 2), 0.35D, 0.083D, true, UniformInt.of(4, 6), UniformInt.of(3, 4), UniformInt.of(1, 2), -16, 16, 0.05D, 1));
        register(context, BLACKSTONE_GLOWSTONE_GEODE, GeodePlusFeatureRegistry.GEODE.get(), new GeodeConfiguration(
                new GeodeBlockSettings(simple(Blocks.AIR),
                        simple(Blocks.NETHERRACK),
                        ...
                        GeodePlusTagRegistry.Blocks.GEODES_CANNOT_REPLACE, GeodePlusTagRegistry.Blocks.GEODE_INVALID_BLOCKS),
                new GeodeLayerSettings(1.7D, 2.2D, 3.2D, 4.2D), new GeodeCrackSettings(0.95D, 2.0D, 2), 0.35D, 0.083D, true, UniformInt.of(4, 6), UniformInt.of(3, 4), UniformInt.of(1, 2), -16, 16, 0.05D, 1));
        register(context, GOLD_NUGGET_GEODE, GeodePlusFeatureRegistry.GEODE.get(), new GeodeConfiguration(
                new GeodeBlockSettings(simple(Blocks.AIR),
                        simple(Blocks.NETHERRACK),
                        ...
                        GeodePlusTagRegistry.Blocks.GEODES_CANNOT_REPLACE, GeodePlusTagRegistry.Blocks.GEODE_INVALID_BLOCKS),
                new GeodeLayerSettings(1.7D, 2.2D, 3.2D, 4.2D), new GeodeCrackSettings(0.95D, 2.0D, 2), 0.35D, 0.083D, true, UniformInt.of(4, 6), UniformInt.of(3, 4), UniformInt.of(1, 2), -16, 16, 0.05D, 1));
        register(context, BASALT_GOLD_NUGGET_GEODE, GeodePlusFeatureRegistry.GEODE.get(), new GeodeConfiguration(
                new GeodeBlockSettings(simple(Blocks.AIR),
                        simple(Blocks.NETHERRACK),
                        ...
                        GeodePlusTagRegistry.Blocks.GEODES_CANNOT_REPLACE, GeodePlusTagRegistry.Blocks.GEODE_INVALID_BLOCKS),
                new GeodeLayerSettings(1.7D, 2.2D, 3.2D, 4.2D), new GeodeCrackSettings(0.95D, 2.0D, 2), 0.35D, 0.083D, true, UniformInt.of(4, 6), UniformInt.of(3, 4), UniformInt.of(1, 2), -16, 16, 0.05D, 1));
        register(context, BLACKSTONE_GOLD_NUGGET_GEODE, GeodePlusFeatureRegistry.GEODE.get(), new GeodeConfiguration(
                new GeodeBlockSettings(simple(Blocks.AIR),
                        simple(Blocks.NETHERRACK),
                        ...
                        GeodePlusTagRegistry.Blocks.GEODES_CANNOT_REPLACE, GeodePlusTagRegistry.Blocks.GEODE_INVALID_BLOCKS),
                new GeodeLayerSettings(1.7D, 2.2D, 3.2D, 4.2D), new GeodeCrackSettings(0.95D, 2.0D, 2), 0.35D, 0.083D, true, UniformInt.of(4, 6), UniformInt.of(3, 4), UniformInt.of(1, 2), -16, 16, 0.05D, 1));
        register(context, QUARTZ_GEODE, GeodePlusFeatureRegistry.GEODE.get(), new GeodeConfiguration(
                new GeodeBlockSettings(simple(Blocks.AIR),
                        simple(Blocks.NETHERRACK),
                        ...
                        GeodePlusTagRegistry.Blocks.GEODES_CANNOT_REPLACE, GeodePlusTagRegistry.Blocks.GEODE_INVALID_BLOCKS),
                new GeodeLayerSettings(1.7D, 2.2D, 3.2D, 4.2D), new GeodeCrackSettings(0.95D, 2.0D, 2), 0.35D, 0.083D, true, UniformInt.of(4, 6), UniformInt.of(3, 4), UniformInt.of(1, 2), -16, 16, 0.05D, 1));
        register(context, BASALT_QUARTZ_GEODE, GeodePlusFeatureRegistry.GEODE.get(), new GeodeConfiguration(
                new GeodeBlockSettings(simple(Blocks.AIR),
                        simple(Blocks.NETHERRACK),
                        ...
                        GeodePlusTagRegistry.Blocks.GEODES_CANNOT_REPLACE, GeodePlusTagRegistry.Blocks.GEODE_INVALID_BLOCKS),
                new GeodeLayerSettings(1.7D, 2.2D, 3.2D, 4.2D), new GeodeCrackSettings(0.95D, 2.0D, 2), 0.35D, 0.083D, true, UniformInt.of(4, 6), UniformInt.of(3, 4), UniformInt.of(1, 2), -16, 16, 0.05D, 1));
        register(context, BLACKSTONE_QUARTZ_GEODE, GeodePlusFeatureRegistry.GEODE.get(), new GeodeConfiguration(
                new GeodeBlockSettings(simple(Blocks.AIR),
                        simple(Blocks.NETHERRACK),
                        ...
                        GeodePlusTagRegistry.Blocks.GEODES_CANNOT_REPLACE, GeodePlusTagRegistry.Blocks.GEODE_INVALID_BLOCKS),
                new GeodeLayerSettings(1.7D, 2.2D, 3.2D, 4.2D), new GeodeCrackSettings(0.95D, 2.0D, 2), 0.35D, 0.083D, true, UniformInt.of(4, 6), UniformInt.of(3, 4), UniformInt.of(1, 2), -16, 16, 0.05D, 1));
        register(context, ECHO_GEODE, GeodePlusFeatureRegistry.GEODE.get(), new GeodeConfiguration(
                new GeodeBlockSettings(simple(Blocks.AIR),
                simple(Blocks.SCULK),
                ...
                GeodePlusTagRegistry.Blocks.GEODES_CANNOT_REPLACE ,
                GeodePlusTagRegistry.Blocks.GEODE_INVALID_BLOCKS) ,
        ...
        register(context, WRAPPIST_GEODE, GeodePlusFeatureRegistry.GEODE.get(), new GeodeConfiguration(
                new GeodeBlockSettings(simple(Blocks.AIR),
                ...
                new GeodeLayerSettings(1.7D, 2.2D, 3.2D, 4.2D),
                new GeodeCrackSettings(0.95D, 2.0D, 2), 0.35D, 0.083D, true, UniformInt.of(4, 6), UniformInt.of(3, 4), UniformInt.of(1, 2), -16, 16, 0.05D, 1));
        register(context, PRISMARINE_GEODE, GeodePlusFeatureRegistry.OCEAN_GEODE.get(), new GeodeConfiguration(
                new GeodeBlockSettings(simple(Blocks.WATER),
                        ...
                        GeodePlusTagRegistry.Blocks.GEODES_CANNOT_REPLACE, GeodePlusTagRegistry.Blocks.GEODE_INVALID_BLOCKS),
                new GeodeLayerSettings(1.7D, 2.2D, 3.2D, 4.2D), new GeodeCrackSettings(0.95D, 2.0D, 2), 0.35D, 0.083D, true, UniformInt.of(4, 6), UniformInt.of(3, 4), UniformInt.of(1, 2), -16, 16, 0.05D, 1));
        register(context, DIAMOND_GEODE, GeodePlusFeatureRegistry.GEODE.get(), new GeodeConfiguration(
                new GeodeBlockSettings(simple(Blocks.AIR),
                        simple(Blocks.STONE),
                        ...
                        GeodePlusTagRegistry.Blocks.GEODES_CANNOT_REPLACE, GeodePlusTagRegistry.Blocks.GEODE_INVALID_BLOCKS),
                new GeodeLayerSettings(1.7D, 2.2D, 3.2D, 4.2D), new GeodeCrackSettings(0.95D, 2.0D, 2), 0.35D, 0.083D, true, UniformInt.of(4, 6), UniformInt.of(3, 4), UniformInt.of(1, 2), -16, 16, 0.05D, 1));
        register(context, DEEPSLATE_DIAMOND_GEODE, GeodePlusFeatureRegistry.GEODE.get(), new GeodeConfiguration(
                new GeodeBlockSettings(simple(Blocks.AIR),
                        ...
                        GeodePlusTagRegistry.Blocks.GEODES_CANNOT_REPLACE, GeodePlusTagRegistry.Blocks.GEODE_INVALID_BLOCKS),
                new GeodeLayerSettings(1.7D, 2.2D, 3.2D, 4.2D), new GeodeCrackSettings(0.95D, 2.0D, 2), 0.35D, 0.083D, true, UniformInt.of(4, 6), UniformInt.of(3, 4), UniformInt.of(1, 2), -16, 16, 0.05D, 1));
        register(context, SCULK_DIAMOND_GEODE, GeodePlusFeatureRegistry.GEODE.get(), new GeodeConfiguration(
                new GeodeBlockSettings(simple(Blocks.AIR),
                        simple(Blocks.SCULK),
                        ...
                        GeodePlusTagRegistry.Blocks.GEODES_CANNOT_REPLACE, GeodePlusTagRegistry.Blocks.GEODE_INVALID_BLOCKS),
                new GeodeLayerSettings(1.7D, 2.2D, 3.2D, 4.2D), new GeodeCrackSettings(0.95D, 2.0D, 2), 0.35D, 0.083D, true, UniformInt.of(4, 6), UniformInt.of(3, 4), UniformInt.of(1, 2), -16, 16, 0.05D, 1));
        register(context, EMERALD_GEODE, GeodePlusFeatureRegistry.GEODE.get(), new GeodeConfiguration(
                new GeodeBlockSettings(simple(Blocks.AIR),
                        simple(Blocks.STONE),
                        ...
                        GeodePlusTagRegistry.Blocks.GEODES_CANNOT_REPLACE, GeodePlusTagRegistry.Blocks.GEODE_INVALID_BLOCKS),
                new GeodeLayerSettings(1.7D, 2.2D, 3.2D, 4.2D), new GeodeCrackSettings(0.95D, 2.0D, 2), 0.35D, 0.083D, true, UniformInt.of(4, 6), UniformInt.of(3, 4), UniformInt.of(1, 2), -16, 16, 0.05D, 1));
        register(context, DEEPSLATE_EMERALD_GEODE, GeodePlusFeatureRegistry.GEODE.get(), new GeodeConfiguration(
                new GeodeBlockSettings(simple(Blocks.AIR),
                        simple(Blocks.DEEPSLATE),
                        ...
                        GeodePlusTagRegistry.Blocks.GEODES_CANNOT_REPLACE, GeodePlusTagRegistry.Blocks.GEODE_INVALID_BLOCKS),
                new GeodeLayerSettings(1.7D, 2.2D, 3.2D, 4.2D), new GeodeCrackSettings(0.95D, 2.0D, 2), 0.35D, 0.083D, true, UniformInt.of(4, 6), UniformInt.of(3, 4), UniformInt.of(1, 2), -16, 16, 0.05D, 1));
        register(context, SCULK_EMERALD_GEODE, GeodePlusFeatureRegistry.GEODE.get(), new GeodeConfiguration(
                new GeodeBlockSettings(simple(Blocks.AIR),
                        simple(Blocks.SCULK),
                        ...
                        GeodePlusTagRegistry.Blocks.GEODES_CANNOT_REPLACE, GeodePlusTagRegistry.Blocks.GEODE_INVALID_BLOCKS),
                new GeodeLayerSettings(1.7D, 2.2D, 3.2D, 4.2D), new GeodeCrackSettings(0.95D, 2.0D, 2), 0.35D, 0.083D, true, UniformInt.of(4, 6), UniformInt.of(3, 4), UniformInt.of(1, 2), -16, 16, 0.05D, 1));
        register(context, LAPIS_GEODE, GeodePlusFeatureRegistry.GEODE.get(), new GeodeConfiguration(
                new GeodeBlockSettings(simple(Blocks.AIR),
                        simple(Blocks.STONE),
                        ...
                        GeodePlusTagRegistry.Blocks.GEODES_CANNOT_REPLACE, GeodePlusTagRegistry.Blocks.GEODE_INVALID_BLOCKS),
                new GeodeLayerSettings(1.7D, 2.2D, 3.2D, 4.2D), new GeodeCrackSettings(0.95D, 2.0D, 2), 0.35D, 0.083D, true, UniformInt.of(4, 6), UniformInt.of(3, 4), UniformInt.of(1, 2), -16, 16, 0.05D, 1));
        register(context, DEEPSLATE_LAPIS_GEODE, GeodePlusFeatureRegistry.GEODE.get(), new GeodeConfiguration(
                new GeodeBlockSettings(simple(Blocks.AIR),
                        simple(Blocks.DEEPSLATE),
                        ...
                        GeodePlusTagRegistry.Blocks.GEODES_CANNOT_REPLACE, GeodePlusTagRegistry.Blocks.GEODE_INVALID_BLOCKS),
                new GeodeLayerSettings(1.7D, 2.2D, 3.2D, 4.2D), new GeodeCrackSettings(0.95D, 2.0D, 2), 0.35D, 0.083D, true, UniformInt.of(4, 6), UniformInt.of(3, 4), UniformInt.of(1, 2), -16, 16, 0.05D, 1));
        register(context, SCULK_LAPIS_GEODE, GeodePlusFeatureRegistry.GEODE.get(), new GeodeConfiguration(
                new GeodeBlockSettings(simple(Blocks.AIR),
                        simple(Blocks.SCULK),
                        ...
                        GeodePlusTagRegistry.Blocks.GEODES_CANNOT_REPLACE, GeodePlusTagRegistry.Blocks.GEODE_INVALID_BLOCKS),
                new GeodeLayerSettings(1.7D, 2.2D, 3.2D, 4.2D), new GeodeCrackSettings(0.95D, 2.0D, 2), 0.35D, 0.083D, true, UniformInt.of(4, 6), UniformInt.of(3, 4), UniformInt.of(1, 2), -16, 16, 0.05D, 1));
        register(context, REDSTONE_GEODE, GeodePlusFeatureRegistry.GEODE.get(), new GeodeConfiguration(
                new GeodeBlockSettings(simple(Blocks.AIR),
                        simple(Blocks.STONE),
                        ...
                        GeodePlusTagRegistry.Blocks.GEODES_CANNOT_REPLACE, GeodePlusTagRegistry.Blocks.GEODE_INVALID_BLOCKS),
                new GeodeLayerSettings(1.7D, 2.2D, 3.2D, 4.2D), new GeodeCrackSettings(0.95D, 2.0D, 2), 0.35D, 0.083D, true, UniformInt.of(4, 6), UniformInt.of(3, 4), UniformInt.of(1, 2), -16, 16, 0.05D, 1));
        register(context, DEEPSLATE_REDSTONE_GEODE, GeodePlusFeatureRegistry.GEODE.get(), new GeodeConfiguration(
                new GeodeBlockSettings(simple(Blocks.AIR),
                        simple(Blocks.DEEPSLATE),
                        ...
                        GeodePlusTagRegistry.Blocks.GEODES_CANNOT_REPLACE, GeodePlusTagRegistry.Blocks.GEODE_INVALID_BLOCKS),
                new GeodeLayerSettings(1.7D, 2.2D, 3.2D, 4.2D), new GeodeCrackSettings(0.95D, 2.0D, 2), 0.35D, 0.083D, true, UniformInt.of(4, 6), UniformInt.of(3, 4), UniformInt.of(1, 2), -16, 16, 0.05D, 1));
        register(context, SCULK_REDSTONE_GEODE, GeodePlusFeatureRegistry.GEODE.get(), new GeodeConfiguration(
                new GeodeBlockSettings(simple(Blocks.AIR),
                        simple(Blocks.SCULK),
                        ...
                        GeodePlusTagRegistry.Blocks.GEODES_CANNOT_REPLACE, GeodePlusTagRegistry.Blocks.GEODE_INVALID_BLOCKS),
                new GeodeLayerSettings(1.7D, 2.2D, 3.2D, 4.2D), new GeodeCrackSettings(0.95D, 2.0D, 2), 0.35D, 0.083D, true, UniformInt.of(4, 6), UniformInt.of(3, 4), UniformInt.of(1, 2), -16, 16, 0.05D, 1));
        register(context, CELESTITE_GEODE, GeodePlusFeatureRegistry.GEODE.get(), new GeodeConfiguration(
                new GeodeBlockSettings(simple(Blocks.AIR),
                        ...
                        GeodePlusTagRegistry.Blocks.GEODES_CANNOT_REPLACE, GeodePlusTagRegistry.Blocks.GEODE_INVALID_BLOCKS),
                new GeodeLayerSettings(1.7D, 2.2D, 3.2D, 4.2D), new GeodeCrackSettings(0.95D, 2.0D, 2), 0.35D, 0.083D, true, UniformInt.of(4, 6), UniformInt.of(3, 4), UniformInt.of(1, 2), -16, 16, 0.05D, 1));
        register(context, PINK_TOPAZ_GEODE, GeodePlusFeatureRegistry.GEODE.get(), new GeodeConfiguration(
                new GeodeBlockSettings(simple(Blocks.AIR),
