...
public class GeodeModPlacedFeaturesRegistry {
    ...
    public static final Supplier<PlacedFeature> QUARTZ_GEODE = RegistryHelper.registerPlacedFeature("quartz_geode", () -> new PlacedFeature((Holder<ConfiguredFeature<?,?>>)(Holder<? extends ConfiguredFeature<?,?>>) GeodeModConfiguredFeaturesRegistry.QUARTZ_GEODE, List.of(rarityNetherQuartzGeode(), inSquarePlacement(), placementNetherModifier(), biomeFilter())));
    public static final Supplier<PlacedFeature> BLACKSTONE_QUARTZ_GEODE = RegistryHelper.registerPlacedFeature("blackstone_quartz_geode", () -> new PlacedFeature((Holder<ConfiguredFeature<?,?>>)(Holder<? extends ConfiguredFeature<?,?>>) GeodeModConfiguredFeaturesRegistry.BLACKSTONE_QUARTZ_GEODE, List.of(rarityBlackstoneQuartzGeode(), inSquarePlacement(), placementNetherModifier(), biomeFilter())));

    public static final Supplier<PlacedFeature> WRAPPIST_GEODE = RegistryHelper.registerPlacedFeature("wrappist_geode", () -> new PlacedFeature((Holder<ConfiguredFeature<?,?>>)(Holder<? extends ConfiguredFeature<?,?>>) GeodeModConfiguredFeaturesRegistry.WRAPPIST_GEODE, List.of(rarityEndWrappistGeode(), inSquarePlacement(), placementEndModifier(), biomeFilter())));


    public static final Supplier<PlacedFeature> GLOWSTONE_GEODE = RegistryHelper.registerPlacedFeature("glowstone_geode", () -> new PlacedFeature((Holder<ConfiguredFeature<?,?>>)(Holder<? extends ConfiguredFeature<?,?>>) GeodeModConfiguredFeaturesRegistry.GLOWSTONE_GEODE, List.of(rarityNetherGlowstoneGeode(), inSquarePlacement(), placementNetherModifier(), biomeFilter())));

    public static final Supplier<PlacedFeature> ANCIENT_DEBRIS_GEODE = RegistryHelper.registerPlacedFeature("ancient_debris_geode", () -> new PlacedFeature((Holder<ConfiguredFeature<?,?>>)(Holder<? extends ConfiguredFeature<?,?>>) GeodeModConfiguredFeaturesRegistry.ANCIENT_DEBRIS_GEODE, List.of(rarityNetherAncientDebrisGeode(), inSquarePlacement(), placementNetherModifier(), biomeFilter())));
    ...
    public static final Supplier<PlacedFeature> BLACKSTONE_GLOWSTONE_GEODE = RegistryHelper.registerPlacedFeature("blackstone_glowstone_geode", () -> new PlacedFeature((Holder<ConfiguredFeature<?,?>>)(Holder<? extends ConfiguredFeature<?,?>>) GeodeModConfiguredFeaturesRegistry.BLACKSTONE_GLOWSTONE_GEODE, List.of(rarityBlackstoneGlowstoneGeode(), inSquarePlacement(), placementNetherModifier(), biomeFilter())));

    public static final Supplier<PlacedFeature> GOLD_NUGGET_GEODE = RegistryHelper.registerPlacedFeature("gold_nugget_geode", () -> new PlacedFeature((Holder<ConfiguredFeature<?,?>>)(Holder<? extends ConfiguredFeature<?,?>>) GeodeModConfiguredFeaturesRegistry.GOLD_NUGGET_GEODE, List.of(rarityNetherGoldNuggetGeode(), inSquarePlacement(), placementNetherModifier(), biomeFilter())));


    public static final Supplier<PlacedFeature> BLACKSTONE_GOLD_NUGGET_GEODE = RegistryHelper.registerPlacedFeature("blackstone_gold_nugget_geode", () -> new PlacedFeature((Holder<ConfiguredFeature<?,?>>)(Holder<? extends ConfiguredFeature<?,?>>) GeodeModConfiguredFeaturesRegistry.BLACKSTONE_GOLD_NUGGET_GEODE, List.of(rarityBlackstoneGoldNuggetGeode(), inSquarePlacement(), placementNetherModifier(), biomeFilter())));

    public static final Supplier<PlacedFeature> ECHO_GEODE = RegistryHelper.registerPlacedFeature("echo_geode", () -> new PlacedFeature((Holder<ConfiguredFeature<?,?>>)(Holder<? extends ConfiguredFeature<?,?>>) GeodeModConfiguredFeaturesRegistry.ECHO_GEODE, List.of(rarityEchoGeode(), inSquarePlacement(), placementDeepDarkModifier(), biomeFilter())));
    ...
    public static final Supplier<PlacedFeature> ECHO_CRYSTAL_SPIKE = RegistryHelper.registerPlacedFeature("echo_crystal_spike", () -> new PlacedFeature((Holder<ConfiguredFeature<?,?>>)(Holder<? extends ConfiguredFeature<?,?>>) GeodeModConfiguredFeaturesRegistry.ECHO_CRYSTAL_SPIKE, List.of(inSquarePlacement(), placementEchoCrystalModifier(), biomeFilter())));
    ...
    public static final Supplier<PlacedFeature> WRAPPIST_CRYSTAL_SPIKE = RegistryHelper.registerPlacedFeature("wrappist_crystal_spike", () -> new PlacedFeature((Holder<ConfiguredFeature<?,?>>)(Holder<? extends ConfiguredFeature<?,?>>) GeodeModConfiguredFeaturesRegistry.WRAPPIST_CRYSTAL_SPIKE, List.of(placementEndCrystal(), inSquarePlacement(), placementNetherCrystalModifier(), biomeFilter())));
    ...
    private static RarityFilter rarityPrismarineGeode() {
        return RarityFilter.onAverageOnceEvery(GeodeModCommonConfigs.RARITY_DEEP_OCEAN_PRISMARINE_GEODE.get());
    }
    //Netherrack
    private static RarityFilter rarityNetherAncientDebrisGeode(){return RarityFilter.onAverageOnceEvery(GeodeModCommonConfigs.RARITY_NETHER_DEBRIS_GEODE.get());}
    private static RarityFilter rarityNetherGlowstoneGeode(){return RarityFilter.onAverageOnceEvery(GeodeModCommonConfigs.RARITY_NETHER_GLOWSTONE_GEODE.get());}
    private static RarityFilter rarityNetherGoldNuggetGeode(){return RarityFilter.onAverageOnceEvery(GeodeModCommonConfigs.RARITY_NETHER_GOLD_NUGGET_GEODE.get());}
    private static RarityFilter rarityNetherQuartzGeode(){return RarityFilter.onAverageOnceEvery(GeodeModCommonConfigs.RARITY_NETHER_QUARTZ_GEODE.get());}
    //Basalt
    private static RarityFilter rarityBasaltAncientDebrisGeode(){return RarityFilter.onAverageOnceEvery(GeodeModCommonConfigs.RARITY_BASALT_DEBRIS_GEODE.get());}
    private static RarityFilter rarityBasaltGlowstoneGeode(){return RarityFilter.onAverageOnceEvery(GeodeModCommonConfigs.RARITY_BASALT_GLOWSTONE_GEODE.get());}
    private static RarityFilter rarityBasaltGoldNuggetGeode(){return RarityFilter.onAverageOnceEvery(GeodeModCommonConfigs.RARITY_BASALT_GOLD_NUGGET_GEODE.get());}
    private static RarityFilter rarityBasaltQuartzGeode(){return RarityFilter.onAverageOnceEvery(GeodeModCommonConfigs.RARITY_BASALT_QUARTZ_GEODE.get());}
    //Blackstone
    private static RarityFilter rarityBlackstoneAncientDebrisGeode(){return RarityFilter.onAverageOnceEvery(GeodeModCommonConfigs.RARITY_BLACKSTONE_DEBRIS_GEODE.get());}
    private static RarityFilter rarityBlackstoneGlowstoneGeode(){return RarityFilter.onAverageOnceEvery(GeodeModCommonConfigs.RARITY_BLACKSTONE_GLOWSTONE_GEODE.get());}
    private static RarityFilter rarityBlackstoneGoldNuggetGeode(){return RarityFilter.onAverageOnceEvery(GeodeModCommonConfigs.RARITY_BLACKSTONE_GOLD_NUGGET_GEODE.get());}
    private static RarityFilter rarityBlackstoneQuartzGeode(){return RarityFilter.onAverageOnceEvery(GeodeModCommonConfigs.RARITY_BLACKSTONE_QUARTZ_GEODE.get());}
    ...
    private static RarityFilter rarityEndWrappistGeode() {
        return RarityFilter.onAverageOnceEvery(GeodeModCommonConfigs.RARITY_END_WRAPPIST_GEODE.get());
    }
    private static RarityFilter rarityEchoGeode() {
        return RarityFilter.onAverageOnceEvery(GeodeModCommonConfigs.RARITY_ECHO_GEODE.get());
    }

    private static RarityFilter rarityOreGeode() {
        return RarityFilter.onAverageOnceEvery(GeodeModCommonConfigs.RARITY_ORES_GEODE.get());
    }

    private static RarityFilter rarityRareOreGeode() {
        return RarityFilter.onAverageOnceEvery(GeodeModCommonConfigs.RARITY_RARE_ORES_GEODE.get());
    }
